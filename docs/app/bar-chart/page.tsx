  ...
  return (
    ...
    >
      <Demo
        ...
        code={`import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend } from '@rsuite/charts';
...
<BarChart height={280} data={data}>
  ...
  <Bar dataKey="value" name="访问次数" />
      ...
      >
        <BarChart height={280} data={basicData}>
          <CartesianGrid />
          <XAxis dataKey="name" />
          <YAxis />
          <Tooltip />
...
<BarChart height={300} data={stackData}>
  <CartesianGrid />
...
<BarChart height={300} data={monthlyData} horizontal>
  <CartesianGrid />
  <XAxis type="number" />
  ...
  <Bar dataKey="cost" name="Cost" />
      ...
      <Demo
        title="With Brush (Range Selector)"
        code={`import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Brush } from '@rsuite/charts';

<BarChart height={300} data={basicData}>
  <CartesianGrid />
  <XAxis dataKey="name" />
  <YAxis />
  <Tooltip />
